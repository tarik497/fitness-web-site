                ...
                <div class="container">
                    <div class="row">
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<div class='card h-100'>"; // Utilisez `h-100` pour la hauteur constante des cartes
                            ...
                            echo "<h5 class='card-title'>" . $row['exercice_name'] . "</h5>";
                            echo "<p class='card-text'>" . $row['description'] . "</p>";
                            echo "</div>";
                            
                            // Ajout de la section card-footer pour le bouton
                            echo "<div class='card-footer d-flex justify-content-end'>";
                            echo "<a href='Videoexercices.php?id_exercices=" . $row['id_exercices'] . "' class='btn btn-primary'>Voir la vidéo</a>";
                            echo "</div>";
