            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    <div class="row">
                        <?php 
                        include("config.php");
                        $result = mysqli_query($conn, "SELECT * FROM nutritions");
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<h5 class='card-title'>" . $row['nutrition_name'] . "</h5>";
                            echo "<p class='card-text'>" . $row['description'] . "</p>";
                            echo "</div>";
                            echo "<div class='card-footer d-flex justify-content-end'>"; // Section footer pour le bouton
                            echo "<a href='Videonutrition.php?id_nutritions=" . $row['id_nutritions'] . "' class='btn btn-primary'>Voir la vidéo</a>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                        }
