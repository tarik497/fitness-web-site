        ...
        <main>
            <div class="content-body">
                ...
                <div class='container'>
                    ...
                    if(isset($_GET['id_exercices'])) {
                        $id_exercices = $_GET["id_exercices"];
                        // Récupérer les détails de l'exercice en fonction de l'ID
                        $sql = "SELECT * FROM exercices WHERE id_exercices = $id_exercices";
                    ...
                    <div class="container mt-5">
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <div class="card">
                                    <video controls class="card-video-top">
                    ...
                    <?php
                        ...
                        echo "<p>Aucune vidéo trouvée avec l'ID spécifié.</p>";
                    }
                    } else {
                        // Si 'id' n'est pas défini dans la requête GET
                        echo "<p>Identifiant de l'exercice non spécifié.</p>";
                    }
                    ?>
