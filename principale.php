...
<html lang="en">
  ...
  <body>
    <nav>
      ...
      <ul class="nav__links">
        <li class="link"><a href="#homme">Home</a></li>
    ...
    <section class="section__container class__container">
      <div class="class__image">
        <span class="bg__blur"></span>
        <img src="image/class-1.jpg" alt="class" class="class__img-1" />
        <img src="image/class-2.jpg" alt="class" class="class__img-2" />
      </div>
    ...
    <section class="section__container join__container">
      ...
      <div class="join__image">
        <img src="image/athletic-male-holds-barbell-weight-his-arm-grey-background.jpg" alt="Join" />
        ...
        <div class="review__content">
          ...
          <div class="review__footer">
            <div class="review__member">
              <img src="image/member.jpg" alt="member" />
